 ...
 */
final class Version20200113091432 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rdv (id INT AUTO_INCREMENT NOT NULL, coach_id INT NOT NULL, client_id INT DEFAULT NULL, jour DATE NOT NULL, heure TIME NOT NULL, duree INT NOT NULL, lieu VARCHAR(255) NOT NULL, total INT DEFAULT NULL, INDEX IDX_10C31F863C105691 (coach_id), INDEX IDX_10C31F8619EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
